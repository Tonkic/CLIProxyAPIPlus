...
type Config struct {
	...
	// gemini-cli, vertex, aistudio, antigravity, claude, codex, interactions, iflow, kiro, github-copilot, kimi, xai.
	//
...
type AntigravityConfig struct {
	// SensitiveWords is a list of words to obfuscate in system instructions.
