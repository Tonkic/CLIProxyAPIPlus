...
// AmpModelMapping maps an Amp-requested model to a locally available model.
...
// AmpCode configures Amp CLI upstream routing and fallback model mappings.
type AmpCode struct {
...
// AmpUpstreamAPIKeyEntry maps client API keys to an Amp upstream API key.
type AmpUpstreamAPIKeyEntry struct {
	UpstreamAPIKey string   `yaml:"upstream-api-key" json:"upstream-api-key"`
	APIKeys        []string `yaml:"api-keys" json:"api-keys"`
}

// KiroKey configures Kiro (AWS CodeWhisperer/Amazon Q) authentication.
type KiroKey struct {
