...
func requestExecutionMetadata(ctx context.Context, configs ...*config.SDKConfig) map[string]any {
...
// client's current binding policy. Session-level auth reuse paths call this
// because they do not perform a fresh scheduler pick.
