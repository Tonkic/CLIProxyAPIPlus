...
// RetryAllUpstreamErrorsMetadataKey asks the auth manager to continue to the
// next credential for any upstream execution error until candidates are
// exhausted. Local validation errors and client cancellation remain terminal.
const RetryAllUpstreamErrorsMetadataKey = "retry_all_upstream_errors"
